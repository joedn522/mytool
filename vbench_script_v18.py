...
import os, csv, time, argparse, subprocess, json
...
TMP_DIR     = "./tmp"
SENTINEL    = ("__DONE__", None, None, None, None)   # 對應 queue item 長度
...
def main():
    ...
    with Manager() as m:
        ...
        results = m.list(skip_rows)   # 先塞已跳過的
